---
title: Configuration
description: Learn how to configure the Lando LOMP recipe.
---
...
The [recipe config](https://docs.lando.dev/config/recipes.html#config) to set the LOMP recipe to use `php` version `5.3` is shown below:
...
The default database connection information for a LOMP site is shown below:
...
You may need to override our [default LOMP config](https://github.com/lando/lomp/tree/main/recipes/lomp) with your own.
...
**Landofile using custom lomp config**
