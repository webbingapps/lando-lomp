---
title: Tooling
description: Learn about Lando LOMP tooling commands like composer, php, mysql, etc
---

# Tooling

By default, each Lando LOMP recipe will also ship with helpful dev utilities.
...
Once you've started up your LOMP site, you will need to pull in your database and files before you can really start to dev all the dev. Pulling your files is as easy as downloading an archive and extracting it to the correct location. Importing a database can be done using our helpful `lando db-import` command.
